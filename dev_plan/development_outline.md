...
│       └── level_01.tscn      # 关卡1
├── prefabs/                   # 预制件
│   ├── card_prefab.tscn       # 卡牌预制件
│   ├── building_prefab.tscn   # 建筑预制件
│   └── unit_prefab.tscn       # 部队预制件
├── resources/                 # 资源文件
│   ├── card_data.tres         # 卡牌数据配置
│   ├── building_data.tres     # 建筑数据配置
│   └── unit_data.tres         # 部队数据配置
└── assets/                    # 游戏资源
    ├── art/                   # 美术资源
    ├── audio/                 # 音效音乐
    └── fonts/                 # 字体
