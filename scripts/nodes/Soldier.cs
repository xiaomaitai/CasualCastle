...
public partial class Soldier : Area2D
{
    ...
    public override void _Ready()
    {
        ...
        string side = IsPlayerUnit ? "玩家" : "敌方";
        GD.Print($"[Soldier _Ready] {side}士兵初始化，全局位置: {GlobalPosition}, Sprite节点: {(_sprite != null ? "存在" : "null")}, CollisionShape: {(_collisionShape != null ? "存在" : "null")}, Texture: {(_sprite?.Texture != null ? _sprite.Texture.ResourcePath : "null")}");
